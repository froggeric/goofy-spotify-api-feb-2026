...
| [Clerk](/reference/clerk.md) | Methods for executing multiple functions at different times in a single trigger. |
...
| [Player](/reference/player.md) | Methods for player control. |
...
| [Source](/reference/source.md) | Methods for getting Spotify elements. |
